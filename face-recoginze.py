...
class Face_Recognition:
    def __init__(self,root):
            ...
            img_top=Image.open(r"C:\Users\saiso\OneDrive\Documents\Smart Attendance\images\img6.jpeg")
            img_top=img_top.resize((500,550),Image.LANCZOS)
            self.photoimg_top=ImageTk.PhotoImage(img_top)
            
            f_lbl=Label(self.root,image=self.photoimg_top)
            f_lbl.place(x=0,y=55,width=500,height=600)

            #2 image
            img_bottom=Image.open(r"C:\Users\saiso\OneDrive\Documents\Smart Attendance\images\img13.jpg")
            img_bottom=img_bottom.resize((500,550), Image.LANCZOS)
            self.photoimg_bottom=ImageTk. PhotoImage(img_bottom)
            
            f_lbl=Label(self.root,image=self.photoimg_bottom)
            f_lbl.place(x=550,y=55,width=900,height=600)
